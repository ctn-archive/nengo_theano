...
# for test 1
net.make('B', neurons=neurons, dimensions=dimensions)
# for test 2 
net.make('B2', neurons=neurons, dimensions=dimensions, array_size=array_size)
# for test 3
...
Ip = net.make_probe(
    net.nodes['in1'].origin['X'].decoded_output, dt_sample=dt_step, pstc=pstc)
I2p = net.make_probe(
    net.nodes['in2'].origin['X'].decoded_output, dt_sample=dt_step, pstc=pstc)
Ap = net.make_probe(
