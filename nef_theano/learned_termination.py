...
class Learned_Termination():
    ...
    def __init__(self, pre, post, error, weight_matrix):
        ...
        self.post_spikes = self.post.neurons.output # the theano instantaneous spike raster of the post-synaptic neurons
        self.error = error 
    ...
    def update(self):
        ...
        return collections.OrderedDict( {self.weight_matrix: self.learn(self.weight_matrix)} ) 
